...
lv_obj_t * ui_EJECTSPEEDL;
lv_obj_t * ui_EJECTSPEEDslider;
lv_obj_t * ui_EJECTSPEEDvalue;
...
lv_obj_t * ui_Fist_IT_SettingButton;
lv_obj_t * ui_Fist_IT_SettingButtonText;
lv_obj_t * ui_Fist_IT_Settings;
lv_obj_t * ui_Logo7;
lv_obj_t * ui_Fist_IT_ButtonL;
lv_obj_t * ui_Fist_IT_ButtonLText;
lv_obj_t * ui_Fist_IT_ButtonM;
lv_obj_t * ui_Fist_IT_ButtonMText;
lv_obj_t * ui_Fist_IT_ButtonR;
lv_obj_t * ui_Fist_IT_ButtonRText;
lv_obj_t * ui_Fist_IT_SPEEDL;
lv_obj_t * ui_Fist_IT_SPEEDslider;
lv_obj_t * ui_Fist_IT_SPEEDvalue;
lv_obj_t * ui_Fist_IT_ROTATIONL;
lv_obj_t * ui_Fist_IT_ROTATIONslider;
lv_obj_t * ui_Fist_IT_ROTATIONvalue;
lv_obj_t * ui_Fist_IT_PAUSEL;
lv_obj_t * ui_Fist_IT_PAUSEslider;
lv_obj_t * ui_Fist_IT_PAUSEvalue;
lv_obj_t * ui_Fist_IT_ACCELL;
lv_obj_t * ui_Fist_IT_ACCELslider;
lv_obj_t * ui_Batt7;
lv_obj_t * ui_BattValue7;
lv_obj_t * ui_Battery7;
lv_obj_t * ui_Fist_IT_addon;
...
static void ui_event_EJECTButtonR(lv_event_t * e)
{
    ...
    lv_obj_t * ta = lv_event_get_target(e);
    if(event == LV_EVENT_SHORT_CLICKED) {
        _ui_screen_change(ui_Fist_IT_Settings, LV_SCR_LOAD_ANIM_FADE_ON, 90, 0);
    }
}

static void ui_event_ShowEjectLong(lv_event_t * e)
{
    lv_event_code_t event = lv_event_get_code(e);
    lv_obj_t * ta = lv_event_get_target(e);
    if(event == LV_EVENT_LONG_PRESSED) {
        _ui_screen_change(ui_EJECTSettings, LV_SCR_LOAD_ANIM_FADE_ON, 90, 0);
    }
}

static void ui_event_ShowFistItLong(lv_event_t * e)
{
    lv_event_code_t event = lv_event_get_code(e);
    lv_obj_t * ta = lv_event_get_target(e);
    if(event == LV_EVENT_LONG_PRESSED) {
...
//MARCO ADD EJECT OPTIONS EVENTS
...
static void ui_event_Fist_IT_addon(lv_event_t * e)
{
    lv_event_code_t event = lv_event_get_code(e);
    lv_obj_t * ta = lv_event_get_target(e);
    if(event == LV_EVENT_SCREEN_LOADED) {
...
static void ui_event_Fist_IT_ButtonL(lv_event_t * e)
{
    lv_event_code_t event = lv_event_get_code(e);
    lv_obj_t * ta = lv_event_get_target(e);
       if(event == LV_EVENT_SHORT_CLICKED) {
...
static void ui_event_Fist_IT_ButtonM(lv_event_t * e)
{
    lv_event_code_t event = lv_event_get_code(e);
    lv_obj_t * ta = lv_event_get_target(e);
    if(event == LV_EVENT_SHORT_CLICKED) {
...
static void ui_event_Fist_IT_ButtonR(lv_event_t * e)
{
    lv_event_code_t event = lv_event_get_code(e);
    lv_obj_t * ta = lv_event_get_target(e);
    if(event == LV_EVENT_SHORT_CLICKED) {
...
void ui_Menue_screen_init(void)
{
    ...
    lv_label_set_text(ui_MenueButtonRText, T_CONNECT);
...
void ui_EJECTSettings_screen_init(void)
{
    ...
    lv_label_set_text(ui_Logo6, T_EJECT);
...
//ui_event_EJECTButtonR
    lv_obj_add_event_cb(ui_EJECTButtonR, ui_event_EJECTButtonR, LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_EJECTButtonR, ui_event_ShowEjectLong, LV_EVENT_LONG_PRESSED, NULL);
    ...
    lv_label_set_text(ui_EJECTButtonRText, T_Fist_IT);
...
//MARCO
    ...
    ui_EJECTSPEEDL = lv_label_create(ui_EJECTSettings);

    lv_obj_set_width(ui_EJECTSPEEDL, lv_pct(95));
    lv_obj_set_height(ui_EJECTSPEEDL, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_EJECTSPEEDL, 0);
    lv_obj_set_y(ui_EJECTSPEEDL, -60);

    lv_obj_set_align(ui_EJECTSPEEDL, LV_ALIGN_CENTER);

    lv_label_set_text(ui_EJECTSPEEDL, T_CUM_SPEED);

    lv_obj_set_style_text_font(ui_EJECTSPEEDL, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_height(ui_EJECTSPEEDslider, 10);

    lv_obj_set_x(ui_EJECTSPEEDslider, -15);
    lv_obj_set_y(ui_EJECTSPEEDslider, 0);

    lv_obj_set_align(ui_EJECTSPEEDslider, LV_ALIGN_RIGHT_MID);

    lv_obj_set_style_bg_color(ui_EJECTSPEEDslider, lv_color_hex(0xD691D0), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_EJECTSPEEDslider, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_set_style_bg_color(ui_EJECTSPEEDslider, lv_color_hex(0x83277B), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_EJECTSPEEDslider, 255, LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui_EJECTSPEEDslider, lv_color_hex(0x83277B), LV_PART_INDICATOR | LV_STATE_DEFAULT);

    lv_obj_set_style_bg_color(ui_EJECTSPEEDslider, lv_color_hex(0x83277B), LV_PART_KNOB | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_EJECTSPEEDslider, 255, LV_PART_KNOB | LV_STATE_DEFAULT);

    // ui_EJECTSPEEDvalue

    ui_EJECTSPEEDvalue = lv_label_create(ui_EJECTSPEEDL);

    lv_obj_set_width(ui_EJECTSPEEDvalue, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_EJECTSPEEDvalue, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_EJECTSPEEDvalue, 80);
    lv_obj_set_y(ui_EJECTSPEEDvalue, 0);

    lv_obj_set_align(ui_EJECTSPEEDvalue, LV_ALIGN_LEFT_MID);

    lv_label_set_text(ui_EJECTSPEEDvalue, T_BLANK);
    ...
    lv_obj_set_x(ui_EJECTTIMEslider, -15);
    ...
    lv_obj_set_x(ui_EJECTTIMEvalue, 80);
    ...
    lv_obj_set_x(ui_EJECTSIZEslider, -15);
    ...
    lv_obj_set_x(ui_EJECTSIZEvalue, 80);
    ...
    lv_obj_set_y(ui_EJECTACCELL, 45);
    ...
    lv_obj_set_x(ui_EJECTACCELslider, -15);
...
void ui_Fist_IT_Settings_screen_init(void)
{

    // ui_Fist_IT_Settings

    ui_Fist_IT_Settings = lv_obj_create(NULL);

    lv_obj_clear_flag(ui_Fist_IT_Settings, LV_OBJ_FLAG_SCROLLABLE);

    lv_obj_add_event_cb(ui_Fist_IT_Settings, ui_event_Fist_IT_addon, LV_EVENT_ALL, NULL);

    // ui_Logo6

    ui_Logo7 = lv_label_create(ui_Fist_IT_Settings);

    lv_obj_set_width(ui_Logo7, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Logo7, LV_SIZE_CONTENT);

    lv_obj_set_y(ui_Logo7, -103);
    lv_obj_set_x(ui_Logo7, lv_pct(0));

    lv_obj_set_align(ui_Logo7, LV_ALIGN_CENTER);

    lv_label_set_text(ui_Logo7, T_Fist_IT);

    lv_obj_set_style_text_font(ui_Logo7, &lv_font_montserrat_16, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_color(ui_Logo7, lv_color_hex(0x83277B), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_opa(ui_Logo7, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_width(ui_Logo7, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_pad(ui_Logo7, 5, LV_PART_MAIN | LV_STATE_DEFAULT);

    // ui_Fist_IT_ButtonL

    ui_Fist_IT_ButtonL = lv_btn_create(ui_Fist_IT_Settings);

    lv_obj_set_width(ui_Fist_IT_ButtonL, 100);
    lv_obj_set_height(ui_Fist_IT_ButtonL, 30);

    lv_obj_set_y(ui_Fist_IT_ButtonL, 100);
    lv_obj_set_x(ui_Fist_IT_ButtonL, lv_pct(-33));

    lv_obj_set_align(ui_Fist_IT_ButtonL, LV_ALIGN_CENTER);

    lv_obj_add_flag(ui_Fist_IT_ButtonL, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
    lv_obj_clear_flag(ui_Fist_IT_ButtonL, LV_OBJ_FLAG_SCROLLABLE);

    lv_obj_add_event_cb(ui_Fist_IT_ButtonL, ui_event_Fist_IT_ButtonL, LV_EVENT_ALL, NULL);
    lv_obj_set_style_bg_color(ui_Fist_IT_ButtonL, lv_color_hex(0x83277B), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Fist_IT_ButtonL, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    // ui_Fist_IT_ButtonLText

    ui_Fist_IT_ButtonLText = lv_label_create(ui_Fist_IT_ButtonL);

    lv_obj_set_width(ui_Fist_IT_ButtonLText, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Fist_IT_ButtonLText, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Fist_IT_ButtonLText, lv_pct(0));
    lv_obj_set_y(ui_Fist_IT_ButtonLText, lv_pct(0));

    lv_obj_set_align(ui_Fist_IT_ButtonLText, LV_ALIGN_CENTER);

    lv_label_set_text(ui_Fist_IT_ButtonLText, T_Fist_IT);

    lv_obj_set_style_text_color(ui_Fist_IT_ButtonLText, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_Fist_IT_ButtonLText, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    // ui_Fist_IT_ButtonM

    ui_Fist_IT_ButtonM = lv_btn_create(ui_Fist_IT_Settings);

    lv_obj_set_width(ui_Fist_IT_ButtonM, 100);
    lv_obj_set_height(ui_Fist_IT_ButtonM, 30);

    lv_obj_set_y(ui_Fist_IT_ButtonM, 100);
    lv_obj_set_x(ui_Fist_IT_ButtonM, lv_pct(0));

    lv_obj_set_align(ui_Fist_IT_ButtonM, LV_ALIGN_CENTER);

    lv_obj_add_flag(ui_Fist_IT_ButtonM, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
    lv_obj_clear_flag(ui_Fist_IT_ButtonM, LV_OBJ_FLAG_SCROLLABLE);

    lv_obj_add_event_cb(ui_Fist_IT_ButtonM, ui_event_Fist_IT_ButtonM, LV_EVENT_ALL, NULL);
    lv_obj_set_style_bg_color(ui_Fist_IT_ButtonM, lv_color_hex(0x83277B), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Fist_IT_ButtonM, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    // ui_Fist_IT_ButtonMText

    ui_Fist_IT_ButtonMText = lv_label_create(ui_Fist_IT_ButtonM);

    lv_obj_set_width(ui_Fist_IT_ButtonMText, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Fist_IT_ButtonMText, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Fist_IT_ButtonMText, lv_pct(0));
    lv_obj_set_y(ui_Fist_IT_ButtonMText, lv_pct(0));

    lv_obj_set_align(ui_Fist_IT_ButtonMText, LV_ALIGN_CENTER);

    lv_label_set_text(ui_Fist_IT_ButtonMText, T_HOME);

    lv_obj_set_style_text_color(ui_Fist_IT_ButtonMText, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_Fist_IT_ButtonMText, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    // ui_Fist_IT_ButtonR

    ui_Fist_IT_ButtonR = lv_btn_create(ui_Fist_IT_Settings);

    lv_obj_set_width(ui_Fist_IT_ButtonR, 100);
    lv_obj_set_height(ui_Fist_IT_ButtonR, 30);

    lv_obj_set_y(ui_Fist_IT_ButtonR, 100);
    lv_obj_set_x(ui_Fist_IT_ButtonR, lv_pct(33));

    lv_obj_set_align(ui_Fist_IT_ButtonR, LV_ALIGN_CENTER);

    lv_obj_add_flag(ui_Fist_IT_ButtonR, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
    lv_obj_clear_flag(ui_Fist_IT_ButtonR, LV_OBJ_FLAG_SCROLLABLE);

    lv_obj_add_event_cb(ui_Fist_IT_ButtonR, ui_event_Fist_IT_ButtonR, LV_EVENT_ALL, NULL);
    lv_obj_set_style_bg_color(ui_Fist_IT_ButtonR, lv_color_hex(0x83277B), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Fist_IT_ButtonR, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    // ui_Fist_IT_ButtonRText

    ui_Fist_IT_ButtonRText = lv_label_create(ui_Fist_IT_ButtonR);

    lv_obj_set_width(ui_Fist_IT_ButtonRText, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Fist_IT_ButtonRText, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Fist_IT_ButtonRText, lv_pct(0));
    lv_obj_set_y(ui_Fist_IT_ButtonRText, lv_pct(0));

    lv_obj_set_align(ui_Fist_IT_ButtonRText, LV_ALIGN_CENTER);

    lv_label_set_text(ui_Fist_IT_ButtonRText, T_CREAMPIE);

    lv_obj_set_style_text_color(ui_Fist_IT_ButtonRText, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_Fist_IT_ButtonRText, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    // ui_Batt7

    ui_Batt7 = lv_label_create(ui_Fist_IT_Settings);
    ...
    lv_obj_set_style_bg_color(ui_Battery7, lv_color_hex(0xD591D5), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Battery7, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_set_style_bg_color(ui_Battery7, lv_color_hex(0x83247B), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Battery7, 255, LV_PART_INDICATOR | LV_STATE_DEFAULT);

//MARCO

    // ui_Fist_IT_SPEEDL

    ui_Fist_IT_SPEEDL = lv_label_create(ui_Fist_IT_Settings);

    lv_obj_set_width(ui_Fist_IT_SPEEDL, lv_pct(95));
    lv_obj_set_height(ui_Fist_IT_SPEEDL, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Fist_IT_SPEEDL, 0);
    lv_obj_set_y(ui_Fist_IT_SPEEDL, -60);

    lv_obj_set_align(ui_Fist_IT_SPEEDL, LV_ALIGN_CENTER);

    lv_label_set_text(ui_Fist_IT_SPEEDL, T_Fist_IT_SPEED);

    lv_obj_set_style_text_font(ui_Fist_IT_SPEEDL, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);

    // ui_Fist_IT_SPEEDslider

    ui_Fist_IT_SPEEDslider = lv_slider_create(ui_Fist_IT_SPEEDL);
    lv_slider_set_range(ui_Fist_IT_SPEEDslider, 0, 100);
    //lv_slider_set_mode(ui_Fist_IT_SPEEDslider, LV_SLIDER_MODE_SYMMETRICAL);

    lv_obj_set_width(ui_Fist_IT_SPEEDslider, 130);
    lv_obj_set_height(ui_Fist_IT_SPEEDslider, 10);

    lv_obj_set_x(ui_Fist_IT_SPEEDslider, -15);
    lv_obj_set_y(ui_Fist_IT_SPEEDslider, 0);

    lv_obj_set_align(ui_Fist_IT_SPEEDslider, LV_ALIGN_RIGHT_MID);

    lv_obj_set_style_bg_color(ui_Fist_IT_SPEEDslider, lv_color_hex(0xD691D0), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Fist_IT_SPEEDslider, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_set_style_bg_color(ui_Fist_IT_SPEEDslider, lv_color_hex(0x83277B), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Fist_IT_SPEEDslider, 255, LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui_Fist_IT_SPEEDslider, lv_color_hex(0x83277B), LV_PART_INDICATOR | LV_STATE_DEFAULT);

    lv_obj_set_style_bg_color(ui_Fist_IT_SPEEDslider, lv_color_hex(0x83277B), LV_PART_KNOB | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Fist_IT_SPEEDslider, 255, LV_PART_KNOB | LV_STATE_DEFAULT);

    // ui_Fist_IT_SPEEDvalue

    ui_Fist_IT_SPEEDvalue = lv_label_create(ui_Fist_IT_SPEEDL);

    lv_obj_set_width(ui_Fist_IT_SPEEDvalue, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Fist_IT_SPEEDvalue, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Fist_IT_SPEEDvalue, 80);
    lv_obj_set_y(ui_Fist_IT_SPEEDvalue, 0);

    lv_obj_set_align(ui_Fist_IT_SPEEDvalue, LV_ALIGN_LEFT_MID);

    lv_label_set_text(ui_Fist_IT_SPEEDvalue, T_BLANK);

    // ui_Fist_IT_ROTATION

    ui_Fist_IT_ROTATIONL = lv_label_create(ui_Fist_IT_Settings);

    lv_obj_set_width(ui_Fist_IT_ROTATIONL, lv_pct(95));
    lv_obj_set_height(ui_Fist_IT_ROTATIONL, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Fist_IT_ROTATIONL, 0);
    lv_obj_set_y(ui_Fist_IT_ROTATIONL, -25);

    lv_obj_set_align(ui_Fist_IT_ROTATIONL, LV_ALIGN_CENTER);

    lv_label_set_text(ui_Fist_IT_ROTATIONL, T_Fist_IT_ROTATION);

    lv_obj_set_style_text_font(ui_Fist_IT_ROTATIONL, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);

    // ui_Fist_IT_ROTATIONslider

    ui_Fist_IT_ROTATIONslider = lv_slider_create(ui_Fist_IT_ROTATIONL);
    lv_slider_set_range(ui_Fist_IT_ROTATIONslider, 0, 360);

    lv_obj_set_width(ui_Fist_IT_ROTATIONslider, 130);
    lv_obj_set_height(ui_Fist_IT_ROTATIONslider, 10);

    lv_obj_set_x(ui_Fist_IT_ROTATIONslider, -15);
    lv_obj_set_y(ui_Fist_IT_ROTATIONslider, 0);

    lv_obj_set_align(ui_Fist_IT_ROTATIONslider, LV_ALIGN_RIGHT_MID);

    lv_obj_set_style_bg_color(ui_Fist_IT_ROTATIONslider, lv_color_hex(0xD691D0), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Fist_IT_ROTATIONslider, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_set_style_bg_color(ui_Fist_IT_ROTATIONslider, lv_color_hex(0x83277B), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Fist_IT_ROTATIONslider, 255, LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui_Fist_IT_ROTATIONslider, lv_color_hex(0x83277B), LV_PART_INDICATOR | LV_STATE_DEFAULT);

    lv_obj_set_style_bg_color(ui_Fist_IT_ROTATIONslider, lv_color_hex(0x83277B), LV_PART_KNOB | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Fist_IT_ROTATIONslider, 255, LV_PART_KNOB | LV_STATE_DEFAULT);

    // ui_Fist_IT_ROTATIONvalue

    ui_Fist_IT_ROTATIONvalue = lv_label_create(ui_Fist_IT_ROTATIONL);

    lv_obj_set_width(ui_Fist_IT_ROTATIONvalue, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Fist_IT_ROTATIONvalue, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Fist_IT_ROTATIONvalue, 80);
    lv_obj_set_y(ui_Fist_IT_ROTATIONvalue, 0);

    lv_obj_set_align(ui_Fist_IT_ROTATIONvalue, LV_ALIGN_LEFT_MID);

    lv_label_set_text(ui_Fist_IT_ROTATIONvalue, T_BLANK);

    // ui_Fist_IT_PAUSEL

    ui_Fist_IT_PAUSEL = lv_label_create(ui_Fist_IT_Settings);

    lv_obj_set_width(ui_Fist_IT_PAUSEL, lv_pct(95));
    lv_obj_set_height(ui_Fist_IT_PAUSEL, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Fist_IT_PAUSEL, 0);
    lv_obj_set_y(ui_Fist_IT_PAUSEL, 10);

    lv_obj_set_align(ui_Fist_IT_PAUSEL, LV_ALIGN_CENTER);

    lv_label_set_text(ui_Fist_IT_PAUSEL, T_Fist_IT_PAUSE);

    lv_obj_set_style_text_font(ui_Fist_IT_PAUSEL, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);

    // ui_Fist_IT_PAUSEslider (per 10th of a second)

    ui_Fist_IT_PAUSEslider = lv_slider_create(ui_Fist_IT_PAUSEL);
    lv_slider_set_range(ui_Fist_IT_PAUSEslider, 0, 100);

    lv_obj_set_width(ui_Fist_IT_PAUSEslider, 130);
    lv_obj_set_height(ui_Fist_IT_PAUSEslider, 10);

    lv_obj_set_x(ui_Fist_IT_PAUSEslider, -15);
    lv_obj_set_y(ui_Fist_IT_PAUSEslider, 0);

    lv_obj_set_align(ui_Fist_IT_PAUSEslider, LV_ALIGN_RIGHT_MID);

    lv_obj_set_style_bg_color(ui_Fist_IT_PAUSEslider, lv_color_hex(0xD691D0), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Fist_IT_PAUSEslider, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_set_style_bg_color(ui_Fist_IT_PAUSEslider, lv_color_hex(0x83277B), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Fist_IT_PAUSEslider, 255, LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui_Fist_IT_PAUSEslider, lv_color_hex(0x83277B), LV_PART_INDICATOR | LV_STATE_DEFAULT);

    lv_obj_set_style_bg_color(ui_Fist_IT_PAUSEslider, lv_color_hex(0x83277B), LV_PART_KNOB | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Fist_IT_PAUSEslider, 255, LV_PART_KNOB | LV_STATE_DEFAULT);

    // ui_Fist_IT_PAUSEvalue

    ui_Fist_IT_PAUSEvalue = lv_label_create(ui_Fist_IT_PAUSEL);

    lv_obj_set_width(ui_Fist_IT_PAUSEvalue, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Fist_IT_PAUSEvalue, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Fist_IT_PAUSEvalue, 80);
    lv_obj_set_y(ui_Fist_IT_PAUSEvalue, 0);

    lv_obj_set_align(ui_Fist_IT_PAUSEvalue, LV_ALIGN_LEFT_MID);

    lv_label_set_text(ui_Fist_IT_PAUSEvalue, T_BLANK);

    // ui_Fist_IT_ACCELL

    ui_Fist_IT_ACCELL = lv_label_create(ui_Fist_IT_Settings);

    lv_obj_set_width(ui_Fist_IT_ACCELL, lv_pct(95));
    lv_obj_set_height(ui_Fist_IT_ACCELL, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Fist_IT_ACCELL, 0);
    lv_obj_set_y(ui_Fist_IT_ACCELL, 45);

    lv_obj_set_align(ui_Fist_IT_ACCELL, LV_ALIGN_CENTER);

    lv_label_set_text(ui_Fist_IT_ACCELL, T_Fist_IT_Accel);

    lv_obj_set_style_text_font(ui_Fist_IT_ACCELL, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);

    // ui_Fist_IT_ACCELslider

    ui_Fist_IT_ACCELslider = lv_slider_create(ui_Fist_IT_ACCELL);
    lv_slider_set_range(ui_Fist_IT_ACCELslider, 0, 100);
    lv_slider_set_mode(ui_Fist_IT_ACCELslider, LV_SLIDER_MODE_SYMMETRICAL);

    lv_obj_set_width(ui_Fist_IT_ACCELslider, 170);
    lv_obj_set_height(ui_Fist_IT_ACCELslider, 10);

    lv_obj_set_x(ui_Fist_IT_ACCELslider, -15);
    lv_obj_set_y(ui_Fist_IT_ACCELslider, 0);

    lv_obj_set_align(ui_Fist_IT_ACCELslider, LV_ALIGN_RIGHT_MID);

    lv_obj_set_style_bg_color(ui_Fist_IT_ACCELslider, lv_color_hex(0xD691D0), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Fist_IT_ACCELslider, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_set_style_bg_color(ui_Fist_IT_ACCELslider, lv_color_hex(0x83277B), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Fist_IT_ACCELslider, 255, LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui_Fist_IT_ACCELslider, lv_color_hex(0x83277B), LV_PART_INDICATOR | LV_STATE_DEFAULT);

    lv_obj_set_style_bg_color(ui_Fist_IT_ACCELslider, lv_color_hex(0x83277B), LV_PART_KNOB | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_Fist_IT_ACCELslider, 255, LV_PART_KNOB | LV_STATE_DEFAULT);
}
...
//    lv_obj_add_event_cb(ui_ejectaddon, ui_event_ejectaddon, LV_EVENT_ALL, NULL);
    ...
    lv_obj_set_style_bg_color(ui_ejectaddon, lv_color_hex(0x5b0353), LV_PART_MAIN | LV_STATE_FOCUSED);


    // ui_Fist_IT_settings
    ui_Fist_IT_addon = lv_checkbox_create(ui_Settings);
    lv_checkbox_set_text(ui_Fist_IT_addon, T_Fist_IT);

    lv_obj_set_width(ui_Fist_IT_addon, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Fist_IT_addon, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Fist_IT_addon, 10);
    lv_obj_set_y(ui_Fist_IT_addon, -20);

    lv_obj_set_align(ui_Fist_IT_addon, LV_ALIGN_LEFT_MID);

    lv_obj_add_flag(ui_Fist_IT_addon, LV_OBJ_FLAG_SCROLL_ON_FOCUS);

//    lv_obj_add_event_cb(ui_Fist_IT_addon, ui_event_Fist_IT_addon, LV_EVENT_ALL, NULL);

    lv_obj_set_style_text_font(ui_Fist_IT_addon, &lv_font_montserrat_30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_Fist_IT_addon, lv_color_hex(0x5b0353), LV_PART_MAIN | LV_STATE_FOCUSED);
...
void ui_init(void)
{
    ...
    ui_Fist_IT_Settings_screen_init();
