...
#define EJECT_ID 2 //Eject Default can be changed with M5 Remote in the Future will be Saved in EPROOM
#define FIST_ID 3 //Fist-IT Default can be changed with M5 Remote in the Future will be Saved in EPROOM
#define M5_ID 99 //M5_ID Default can be changed with M5 Remote in the Future will be Saved in EPROOM
#define BATTERY_CHARGE_CURRENT 700 // Charge current, must be one of AXP192::CHGCurrent
